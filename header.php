...
<header>
    <div class="marquee">
        <p>
            <img src="https://test.yuginiistores.com/images/ordernow.png" title="Yuginii" alt="ordernow" class="ordernow" />
            Welcome to Vishwa Sarees Ellampillai online store. We are open for business. Place your
            order now! We are delivering all over India. Order now and get it delivered
            at your doorstep.
        </p>
    </div>
    <!-- Header desktop -->
...
<!-- Logo desktop -->
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li>
                            <a href="retails_shop.php">Shop</a>
                        </li>
                ...
                <div class="wrap-icon-header flex-w flex-r-m">
                    ...
                    <a href="#productview" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11">
                        <img src="https://test.yuginiistores.com/images/rb_5045.png" alt="sale" width="80">
                    </a>
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <img src="images/icons/logo1.png" width="100" alt="KK" />
        </div>
    ...
    <div class="menu-mobile">
        ...
        <ul class="main-menu-m">
            ...
            <li>
                <a href="retails_shop.php">Products Shop</a>
            </li>
